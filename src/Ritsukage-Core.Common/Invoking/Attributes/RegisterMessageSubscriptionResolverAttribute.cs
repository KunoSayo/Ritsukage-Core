...
namespace RUCore.Common.Invoking.Attributes
{
    ...
    public class RegisterMessageSubscriptionResolverAttribute : RegisterBaseAttribute
    {
        ...
        public RegisterMessageSubscriptionResolverAttribute(Type implementationType, ServiceLifetime? lifetime) : base(
        ...
        protected override Type GetServiceType(Type implementationType)
        {
            ...
            throw new ArgumentException($"Given {implementationType.Name} does not implement {openGeneric.Name}",
